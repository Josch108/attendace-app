...
# Starts the FastAPI backend, opens the Dashboard in browser, and launches Vision.
# ==============================================================================
...
# Ensure clean termination of all child processes upon exit or Ctrl+C
cleanup() {
...
echo "     (Press 'q' in the video window or Ctrl+C in terminal to stop everything)"
echo "------------------------------------------------------"

"$VENV_PYTHON" vision/main.py --source 0 --group "Group A" "$@"
